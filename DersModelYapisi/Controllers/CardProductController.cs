...
namespace DersModelYapisi.Controllers
{
    public class CardProductController : Controller
    {
        ...
        {
            var product1 = new Product { Id = 1, Name = "Notebook", Price = 1400 };
            var product2 = new Product { Id = 2, Name = "Iphone", Price = 1500 };
            var product3 = new Product { Id = 3, Name = "Playstation", Price = 400 };
